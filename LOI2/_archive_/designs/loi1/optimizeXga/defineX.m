...
%% Design Parameters %%
Xparams.nconds=3;                       % number of conditions
Xparams.trialsPerCond=[32 32 32];     % number of trials in each condition (length must much nconds)
Xparams.maxRep=3;                       % maximum number of repeat trials from same condition
Xparams.trialDur=1;               % trial length (in seconds)
Xparams.minISI=.5;               % mininimum interstimulus interval (in seconds)
Xparams.maxISI=2.25;               % maximum interstimulus interval (in seconds)
Xparams.meanISI=.75;              % desired mean interstimulus interval (in seconds)
Xparams.restBegin=5;            % amount of rest to add in beginning of scan (in seconds)
Xparams.restEnd=5;             % amount of rest to add at end of scan (in seconds)
...
f1 = 0:25; % adjust this to adjust the number of different distributions to test
f2 = 0:25;
