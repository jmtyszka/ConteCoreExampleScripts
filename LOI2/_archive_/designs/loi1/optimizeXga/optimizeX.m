...
% conditions. 1: 1to2, 2: 2to3, 3: 3to4, 4: 2to1, 5: 3to2, 6: 4to3
L = [1 0 -1; ...
     0 1 -1; ...
     1 -1 0]; % contrasts of interest (rows are contrast vectors)
conWeights=[1 1 1]; % how to weight each contrast in overall efficiency estimation?
gensize = 5000; % generation size
ngen = 500; % maximum number of generations to run
maxtime = 2*60; % maximum time (in minutes)
