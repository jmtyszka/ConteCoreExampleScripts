...
Xparams.trialsPerCond=[4 4 4 4];     % number of trials in each condition (length must much nconds)
Xparams.maxRep=1;                       % maximum number of repeat trials from same condition
Xparams.trialDur=13;               % trial length (in seconds)
Xparams.minISI=4;               % mininimum interstimulus interval (in seconds)
Xparams.maxISI=9;               % maximum interstimulus interval (in seconds)
Xparams.meanISI=5;              % desired mean interstimulus interval (in seconds)
Xparams.restBegin=4;            % amount of rest to add in beginning of scan (in seconds)
Xparams.restEnd=2;             % amount of rest to add at end of scan (in seconds)
